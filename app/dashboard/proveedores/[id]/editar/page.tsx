        ...
        <Section title="Datos generales" icon="fa-solid fa-building">
          <div className="grid grid-cols-2 gap-4">
            ...
            <Field label="País" required>
              <input type="text" value={form.pais} onChange={(e) => set("pais", e.target.value)} className={inputCls} />
            </Field>
            <Field label="Ciudad" required>
              <input type="text" value={form.ciudad} onChange={(e) => set("ciudad", e.target.value)} className={inputCls} />
            </Field>
        ...
        <Section title="Datos fiscales" icon="fa-solid fa-file-invoice">
          <div className="grid grid-cols-2 gap-4">
            ...
            <Field label="Forma de pago">
              <input type="text" value={form.formaPago} onChange={(e) => set("formaPago", e.target.value)} className={inputCls} />
            </Field>
