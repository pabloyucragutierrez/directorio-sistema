...
const proveedor = {
  id: 1, razonSocial: "Importaciones XYZ S.A.", pais: "Perú", ciudad: "Lima",
  direccion: "Av. Principal 123", distrito: "Miraflores", codigoPostal: "15074",
  referencia: "Cerca al parque Kennedy", entrega: "Sí", email: "contacto@xyz.com",
  ruc: "20512345678", licencia: "LIC-000456", telefono: "+51 1 234 5678",
  whatsapp: "+51 987 654 321", representante: "Juan Pérez", dni: "12345678",
  telefonoRep: "+51 987 000 111", formaPago: "Transferencia bancaria",
    ...
    <div className="p-6 mx-auto">
      ...
      <div className="space-y-4">
        <DetailSection title="Datos generales" icon="fa-solid fa-building" rows={[
          ["Razón social", proveedor.razonSocial], ["País", proveedor.pais],
          ["Ciudad", proveedor.ciudad], ["Dirección", proveedor.direccion],
          ["Distrito / Zona", proveedor.distrito], ["Código postal", proveedor.codigoPostal],
          ["Referencia", proveedor.referencia], ["Entrega", proveedor.entrega],
        ...
        <DetailSection title="Representante legal" icon="fa-solid fa-user-tie" rows={[
          ["Nombre", proveedor.representante], ["DNI / CI / ID", proveedor.dni],
      ...
      <div className="flex justify-end mt-6">
        <button
          onClick={() => router.push(`/dashboard/proveedores/${proveedor.id}/editar`)}
