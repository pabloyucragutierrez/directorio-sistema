  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-end gap-3 mb-6">
        ...
        <button className="bg-blue-700 hover:bg-blue-600 text-white text-sm font-medium px-4 py-2 rounded-lg transition cursor-pointer flex items-center gap-2">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-100">
              ...
              <th className="text-left px-5 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Pedidos</th>
              <th className="text-left px-5 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Completados</th>
              <th className="text-left px-5 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Tasa</th>
              <th className="text-left px-5 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Calificación</th>
            </tr>
          </thead>
            ...
            {pedidos.map((p) => {
              ...
              return (
                <tr key={p.proveedor} className="hover:bg-blue-50/50 transition">
                  <td className="px-5 py-3.5 text-slate-800 font-medium">{p.proveedor}</td>
                  <td className="px-5 py-3.5 text-slate-500">{p.total}</td>
                  <td className="px-5 py-3.5 text-slate-500">{p.completados}</td>
